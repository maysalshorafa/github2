...
/**
 * Created by Win8.1 on 10/17/2017.
 */
...
public class ClubCatalogGridViewAdapter  extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            ...
            gridView=inflater.inflate(R.layout.grid_view_item_club,null);
        }

        TextView tvClubName=(TextView)gridView.findViewById(R.id.clubGridView_TVClubName);
