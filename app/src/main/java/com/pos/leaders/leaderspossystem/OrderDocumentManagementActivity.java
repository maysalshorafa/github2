...
public class OrderDocumentManagementActivity extends AppCompatActivity {
    ...
    public static List<Invoice> orderDocumentsList =new ArrayList<>();
   ...
   orderListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                try { Intent intent = new Intent(OrderDocumentManagementActivity.this, SalesCartActivity.class);
                    Invoice invoice = orderDocumentsList.get(position);
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray.length() ; i++) {
                       String msgData1 = jsonArray.getJSONObject(i).toString();
                        ...
                        invoice = new Invoice(DocumentType.ORDER_DOCUMENT,msgDataJson.getJSONObject("documentsData"),msgDataJson.getString("docNum"));
