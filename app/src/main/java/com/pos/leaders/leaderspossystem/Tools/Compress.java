...
class test{
    public static void main1(String[] args){
        ...
        s[0]="C:/Employee/TOSHIBA/Desktop/11/clover-pos-station-front.jpg";    //Type the path of the files in here
        s[1]="C:/Employee/TOSHIBA/Desktop/11/shopify-pos-uk.jpg"; // path of the second file
        new Compress(s,"C:/Employee/TOSHIBA/Desktop/11/MyZipFolder.zip").zip();
