...
public class ZReportDBAdapter {
    ...
    protected static final String Z_REPORT_COLUMN_MINUS_GENERAL_Item= "minusGeneralItemReport";
    ...
    Z_REPORT_COLUMN_TOTAL_TAX_REPORT + "` REAL default 0.0,`"+Z_REPORT_COLUMN_MINUS_GENERAL_Item + "` REAL default 0.0,`"+
    ...
    public long insertEntry(ZReport zReport) {
        ...
        val.put(Z_REPORT_COLUMN_MINUS_GENERAL_Item,zReport.getMinusGeneralItem());
    ...
    private ZReport makeZReport(Cursor c){
           ...
           c.getDouble(c.getColumnIndex(Z_REPORT_COLUMN_INVOICE_AMOUNT)),
            ...
            , c.getDouble(c.getColumnIndex(Z_REPORT_COLUMN_TOTAL_TAX_REPORT)),
                    c.getDouble(c.getColumnIndex(Z_REPORT_COLUMN_MINUS_GENERAL_Item)));
    }
    ...
    public void  test(){
        ...
        for (int  i= 0 ; i<zl.size();i++){
            ...
            totalAmount+=amount;
                ...
                ,zl.get(i).getSalesBeforeTax(),zl.get(i).getSalesWithTax(),zl.get(i).getTotalTax(),zl.get(i).getMinusGeneralItem());
            updateEntry(zReport);
            close();
        }
    }
