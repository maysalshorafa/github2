...
public class ClosingReport{
    ...
    public ClosingReport(long closingReportId, double actualTotalValue, double expectedTotalValue, double differentTotalValue, Timestamp createdAt,long opiningReportId) {
