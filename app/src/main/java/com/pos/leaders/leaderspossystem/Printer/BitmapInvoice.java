...
*/
    ...
    public static Bitmap zPrint(Context context,ZReport zReport, double cash_plus, double cash_minus, double check_plus, double check_minus, double creditCard_plus, double creditCard_minus,boolean isCopy,double starterAmount) {
        ...
        // Create bitmap and canvas to draw to
        //RGB_565
        int Page_Height = sHead.getHeight() + sInvoiceHead.getHeight()+sInvoiceD.getHeight()+slNames.getHeight()+sNewLine.getHeight();
        Bitmap b = Bitmap.createBitmap(PAGE_WIDTH, Page_Height, Bitmap.Config.ARGB_8888);
        Canvas c = new Canvas(b);
    ...
    public static Bitmap xPrint(Context context, User user, long date, double cash_plus, double cash_minus, double check_plus, double check_minus, double creditCard_plus, double creditCard_minus,double starterAmount) {
        //miriam_libre_bold.ttf
        //miriam_libre_regular.ttf
        //carmelitregular.ttf
        int PAGE_WIDTH = 800;
