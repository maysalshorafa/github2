...
public class MiniPrinterFunctions {
	...
	public static void PrintBitmapImage(Context context, String portName, String portSettings, Bitmap bitmap, int maxWidth, boolean compressionEnable, boolean pageModeEnable) {
		ArrayList<byte[]> commands = new ArrayList<byte[]>();
