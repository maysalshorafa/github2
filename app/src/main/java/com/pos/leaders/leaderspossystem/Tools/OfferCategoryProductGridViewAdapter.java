...
public class OfferCategoryProductGridViewAdapter extends BaseAdapter {
    private Context context;
    private List<String> offerCategoryProductList;
    private LayoutInflater inflater;

    public OfferCategoryProductGridViewAdapter(Context context, List<String> offerCategoryProductList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
      ...
      Product product= productDBAdapter.getProductByID(Long.parseLong(offerCategoryProductList.get(position).replaceAll("\\s+","")));
