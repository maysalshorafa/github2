               ...
               removeItemSelection();
                ...
                try {
                    for (int noOfCustomOpt = 0; noOfCustomOpt < storeList.size(); noOfCustomOpt++) {
                        ...
                        customOptionsName.setTextDirection(View.TEXT_DIRECTION_ANY_RTL);
                        ...
                        customOptionsValue.setTextDirection(View.TEXT_DIRECTION_ANY_RTL);
                        customOptionsValue.setGravity(Gravity.CENTER);
                        customOptionsValue.setText(elementValue);
                        lLayout.setTextDirection(View.TEXT_DIRECTION_ANY_RTL);
